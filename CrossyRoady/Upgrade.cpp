...
void Upgrade::Draw(ConsoleGame::AbstractCanvas* canvas) const
{
    ...
    ConsoleGame::Font::DrawString(
        canvas, "be upgraded.", {137, 75}, 1, 0, (char)15
    );
    ConsoleGame::Font::DrawString(
        canvas,
    ...
    ConsoleGame::Font::DrawString(
        canvas, "reduce skill cooldown time.", {137, 115}, 1, 0, (char)15
    );
    ConsoleGame::Font::DrawString(canvas, "Menu", {137, 140}, 1, 0, (char)15);
    ConsoleGame::Font::DrawString(canvas, " ->", {160, 140}, 1, 0, (char)15);
    ConsoleGame::Font::DrawString(
        canvas, " Characters", {178, 140}, 1, 0, (char)15
    );
    ConsoleGame::Font::DrawString(
        canvas, "to upgrade your", {250, 140}, 1, 0, (char)15
    );
    ConsoleGame::Font::DrawString(
        canvas, "characters.", {137, 155}, 1, 0, (char)15
    );
}
