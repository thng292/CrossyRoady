...
void Upgrade::Draw(ConsoleGame::AbstractCanvas* canvas) const
{
    ...
    Font::DrawString(canvas, "To upgrade, you need", {137, 100}, 1, 0);
    Font::DrawString(canvas, "Upgrade point", {264, 100}, 1, 0, (Color)6);
    Font::DrawString(canvas, ".", {340, 100}, 1, 0);
    Font::DrawString(canvas, "You will receive ", {137, 115}, 1, 0);
    Font::DrawString(canvas, "Upgrade point", {240, 115}, 1, 0, (Color)6);
    Font::DrawString(canvas, "after", {324, 115}, 1, 0);
    Font::DrawString(canvas, "each level-up.", {137, 130}, 1, 0);
    Font::DrawString(canvas, "Menu", {137, 155}, 1, 0, (Color)6);
    Font::DrawString(canvas, " ->", {160, 155}, 1, 0);
    Font::DrawString(canvas, " Characters", {178, 155}, 1, 0, Color(6));
    Font::DrawString(canvas, "to upgrade your", {250, 155}, 1, 0);
